...
class Home extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('Admin/home/dashboard',$data,true);
    ...
    {  
        ...
        $data['content'] = $this->load->view('Admin/home/profile', $data, true);
        $this->load->view('Admin/main_wrapper',$data);
    } 
    ...
    public function form()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            $data['content'] = $this->load->view('Admin/home/profile_form',$data,true);
            $this->load->view('Admin/main_wrapper',$data);
        } 
    }
