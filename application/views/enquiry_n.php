...
<div class="row">
    <div class="row" style="background-color: #fff;padding:7px;border-bottom: 1px solid #C8CED3;">
        <div class="col-md-4 col-sm-4 col-xs-4">
            <a class="pull-left fa fa-arrow-left btn btn-circle btn-default btn-sm" onclick="history.back(-1)"
                title="Back"></a>
            <a class="dropdown-toggle btn btn-danger btn-circle btn-sm fa fa-plus" id="enq-create"
                href="<?php echo base_url()?>enquiry/create" title="<?php echo display('add_new_enquiry');?>"></a>
        </div>
            ...
            <div style="float: right;">
                ...
                <div class="btn-group dropdown-filter">
                    ...
                    <button class="btn btn-success" type="button" data-toggle="modal"
                        data-target="#callbreak">Available</button>
                    <?php } elseif($this->session->availability == 2) { ?>
                    <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#callbreak"> Not
                        Available</button>
                    <?php } ?>
                </div>
                <?php } ?>
                <div class="btn-group dropdown-filter">
                    ...
                    <ul class="filter-dropdown-menu dropdown-menu">
                        <li>
                            <label>
                                <input type="checkbox" value="date" id="datecheckbox" name="filter_checkbox"> Date
                            </label>
                        </li>
                        <li>
                            <label>
                        ...
                        <li>
                            <label>
                                <input type="checkbox" value="source" id="sourcecheckbox" name="filter_checkbox">
                                Source</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="subsource" id="subsourcecheckbox"
                                    name="filter_checkbox">Sub Source</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="email" id="emailcheckbox" name="filter_checkbox">
                                Email</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="phone" id="phonecheckbox" name="filter_checkbox">
                                Phone</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="address" id="addcheckbox" name="filter_checkbox">
                                Address</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="datasource" id="datasrccheckbox" name="filter_checkbox">
                                Datasource</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="company" id="companycheckbox" name="filter_checkbox">
                                Company Name</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="created_by" id="createdbycheckbox" name="filter_checkbox">
                                Created By</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="assign_to" id="assigncheckbox" name="filter_checkbox">
                                Assign To</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="process" id="proccheckbox" name="filter_checkbox">
                                Process</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="product" id="prodcheckbox" name="filter_checkbox">
                                Product</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="state" id="statecheckbox" name="filter_checkbox">
                                State</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="city" id="citycheckbox" name="filter_checkbox">
                                City</label>
                        </li>
                        <li>
                            <label>
                                <input type="checkbox" value="stage" id="stageheckbox"
                                    name="filter_checkbox">Stage</label>
                        </li>
                        <li class="text-center">
                            <a href="javascript:void(0)" class="btn btn-sm btn-primary " id='save_advance_filters'
                                title="Save Filters Settings"><i class="fa fa-save"></i></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="btn-group" role="group" aria-label="Button group">
                    ...
                    <div class="dropdown-menu dropdown_css" style="max-height: 400px;overflow: auto;">
                        <?php
              if ($data_type == 1) { ?>
                        <a class="btn" data-toggle="modal" data-target="#AssignSelected"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom :1px solid #fff;"><?php echo display('assign_selected'); ?></a>
                        <a class="btn" data-toggle="modal" data-target="#genLead"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom :1px solid #fff;"><?php echo display('move_to_lead'); ?>
                        </a>
                        <a class="btn" data-toggle="modal" data-target="#dropEnquiry"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('drop_enquiry'); ?></a>
                        <a class="btn" data-target="#sendsms" data-toggle="modal"
                            onclick="getTemplates('1','Send Whatssp');"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('send_whatsapp'); ?>
                        </a>
                        <a class="btn " data-target="#sendsms" data-toggle="modal"
                            onclick="getTemplates('2','Send Sms');"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('send_bulk_sms'); ?></a>
                        <?php
              }else if ($data_type == 2) { ?>
                        <a class="btn" data-toggle="modal" data-target="#AssignSelected"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom :1px solid #fff;"><?php echo display('assign_selected'); ?></a>
                        <a class="btn" data-toggle="modal" data-target="#genclient"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom :1px solid #fff;">Move To
                            <?=display('Client')?> </a>
                        <a class="btn" data-toggle="modal" data-target="#dropEnquiry"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('drop_lead'); ?></a>
                        <a class="btn" data-target="#sendsms" data-toggle="modal"
                            onclick="getTemplates('1','Send Whatssp');"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('send_whatsapp'); ?>
                        </a>
              ...
              ?>
                        ...
                        <a class="btn " data-target="#sendsms" data-toggle="modal"
                            onclick="getTemplates('3','Send Email');"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('send_bulk_email'); ?></a>

                        <?php if(user_access(220)) { if(!empty($this->session->telephony_token)){ ?>
                        <a class="btn " onclick="autoDial()"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('bulk_autodial'); ?></a>
                        <?php } } ?>
                        <a class="btn" data-toggle="modal" data-target="#table-col-conf"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo display('table_config'); ?></a>
                        <a class="btn" data-toggle="modal" data-target="#deleteselected"
                            style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff; display: none;"><?php echo 'Delete Data'; ?></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form method="post" id="enq_filter">
        <div class="row" id="active_class">
            <div class="col-xs-12 col-sm-12  col-md-2 col-lg-2 col-half-offset" style="">
                <div class="col-12 border_bottom">
                    <p style="margin-top: 2vh;font-weight:bold;">
                        <input id='created_today_radio' value="created_today" type="radio" name="top_filter"
                            class="enq_form_filters"><i class="fa fa-edit"></i><label
                            for="created_today_radio">&nbsp;&nbsp;<?php echo display('created_today'); ?></label>
                        <span style="float:right;" class="badge badge-pill badge-primary " id="today_created"><i
            ...
            <div class="col-xs-12 col-sm-12  col-md-2 col-lg-2 col-half-offset">
                <div class="col-12 border_bottom">
                    <p style="margin-top: 2vh;font-weight:bold;">
                        <input type="radio" name="top_filter" value="updated_today" class="enq_form_filters"
                            id="updated_today_radio"><i class="fa fa-pencil"></i><label
                            for="updated_today_radio">&nbsp;&nbsp;<?php echo display('updated_today'); ?></label><span
                            style="float:right;background:#ffc107"
                            class="badge badge-pill badge-warning badge badge-dark " id="today_updated"><i
                                class="fa fa-spinner fa-spin"></i></span>
                    </p>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12  col-md-2 col-lg-2 col-half-offset">
                <div class="col-12 border_bottom border_bottom_active">
                    <p style="margin-top: 2vh;font-weight:bold;" title="<?php echo display('active'); ?>">
                        <input type="radio" name="top_filter" value="active" checked="checked" class="enq_form_filters"
                            id="active_radio"><i class="fa fa-file"></i><label
                            for="active_radio">&nbsp;&nbsp;<?php echo display('active'); ?></label><span
                            style="float:right;" class="badge badge-pill badge-primary " id="active_all"><i
                                class="fa fa-spinner fa-spin"></i></span>
                    </p>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12  col-md-2 col-lg-2 col-half-offset">
                <div class="col-12 border_bottom">
                    <p style="margin-top: 2vh;font-weight:bold;" title="<?php echo display('droped'); ?>">
                        ...
                        <i class="fa fa-thumbs-down"></i><label
                            for="droped_radio">&nbsp;&nbsp;<?php echo display('droped'); ?></label><span
                            style="float:right;background:#E5343D" class="badge badge-danger" id="active_drop"><i
                                class="fa fa-spinner fa-spin"></i></span>
                    </p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12  col-md-2 col-lg-2 col-half-offset">
                <div class="col-12 border_bottom">
                    ...
                    <p style="margin-top: 2vh;font-weight:bold;" title="<?php echo display('total'); ?>">
                        <input type="radio" name="top_filter" value="all" class="enq_form_filters"
                            id="total_active_radio">
                        <i class="fa fa-list"></i><label
                            for="total_active_radio">&nbsp;&nbsp;<?php echo display('total'); ?></label><span
                            style="float:right;background:#000" class="badge badge-pill badge-dark "
                            id="total_active"><i class="fa fa-spinner fa-spin"></i></span>
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="form-group col-md-3" id="subsourcefilter">
                            ...
                            <select class="form-control" name="subsource" id="subsource">
                                ...
                                <option value="<?=$row->subsource_id?>"
                                    <?php if(!empty(set_value('subsource'))){if (in_array($row->lsid,set_value('subsource'))) {echo 'selected';}}?>>
                        ...
                        <div class="form-group col-md-3" id="datasourcefilter">
                            ...
                            <select class="form-control" name="datasource" id="datasource">
                                ...
                                <option value="<?=$row->datasource_id?>"
                                    <?php if(!empty(set_value('datasource_id'))){if (in_array($row->datasource,set_value('datasource_id'))) {echo 'selected';}}?>>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3" id="createdbyfilter">
                            ...
                            <select name="createdby" class="form-control">
                                ...
                                <option value="<?=$createdbylist->pk_i_admin_id;?>"
                                    <?php if(!empty(set_value('createdby'))){if (in_array($product->sb_id,set_value('createdby'))) {echo 'selected';}}?>>
                                    <?=$createdbylist->s_display_name.' '.$createdbylist->last_name;?> -
                                    <?=$createdbylist->s_user_email?$createdbylist->s_user_email:$createdbylist->s_phoneno;?>
                                </option>
                                <?php }}?>
                            </select>
                        </div>
                        <div class="form-group col-md-3" id="assignfilter">
                            ...
                            <select name="assign" class="form-control">
                                ...
                                <?php 
                                      ...
                                      foreach ($created_bylist as $createdbylist) {?>
                                <option value="<?=$createdbylist->pk_i_admin_id;?>"
                                    <?php if(!empty(set_value('assign'))){if (in_array($product->sb_id,set_value('assign'))) {echo 'selected';}}?>>
                                    <?=$createdbylist->s_display_name.' '.$createdbylist->last_name;?> -
                                    <?=$createdbylist->s_user_email?$createdbylist->s_user_email:$createdbylist->s_phoneno;?>
                                </option>
                                <?php }}?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3" id="prodfilter">
                            ...
                            <select name="prodcntry" class="form-control">
                                ...
                                <option value="<?=$prodcntrylist->id;?>"
                                    <?php if(!empty(set_value('prodcntry'))){if (in_array($prodcntrylist->id,set_value('prodcntry'))) {echo 'selected';}}?>>
                        ...
                        <div class="form-group col-md-3" id="statefilter">
                            ...
                            <select name="state" class="form-control" id="state">
                                ...
                                <option value="<?=$statelist->id;?>"
                                    <?php if(!empty(set_value('state'))){if (in_array($statelist->id,set_value('state'))) {echo 'selected';}}?>>
                        ...
                        <div class="form-group col-md-3" id="cityfilter">
                            ...
                            <select name="city" class="form-control" id="city_name">
                                ...
                                <option value="<?=$citylist->id;?>"
                                    <?php if(!empty(set_value('city'))){if (in_array($citylist->id,set_value('city'))) {echo 'selected';}}?>>
                      ...
                      <div class="row">
                          ...
                          <div class="form-group col-sm-6">
                              ...
                              <select class="form-control" id="LeadScore" name="lead_score">
                                  ...
                                  <option value="<?= $score->sc_id?>">
                                      <?= $score->score_name?>&nbsp;<?= $score->probability?></option>
                                  <?php } ?>
                              </select>
                          </div>
                          <div class="form-group col-sm-6">
                  ...
                  <div class="modal-body">
                      <div>
                          ...
                          <div class="form-group col-sm-12">
                              ...
                              <textarea class="form-control" name="message_name" rows="10"
                                  id="template_message"></textarea>
                          </div>
                      </div>
          ...
          <div class="modal-dialog modal-lg" style="width: 96%;">
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <div class="row">
                          <div class="col-md-3">
                              <label class=""><input type="checkbox" id="selectall" onclick="select_all()">&nbsp;Select
                                  All</label>
                          </div>
                      </div>
                      <hr>
                      <div class="row">
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" id="choose-col" value="1"
                                      <?php echo ($showall == true or in_array(1, $acolarr)) ? "checked" : ""; ?>>
                                  <?php echo display("source"); ?></label>
                          </div>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="2"
                                      <?php echo ($showall == true or in_array(2, $acolarr)) ? "checked" : ""; ?>>
                                  Company</label>
                          </div>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="3"
                                      <?php echo ($showall == true or in_array(3, $acolarr)) ? "checked" : ""; ?>>
                                  Name</label>
                          </div>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="4"
                                      <?php echo ($showall == true or in_array(4, $acolarr)) ? "checked" : ""; ?>> Email
                              </label>
                          </div>
                          ...
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="5"
                                      <?php echo ($showall == true or in_array(5, $acolarr)) ? "checked" : ""; ?>> Phone
                              </label>
                          </div>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="6"
                                      <?php echo ($showall == true or in_array(6, $acolarr)) ? "checked" : ""; ?>>
                                  Address</label> &nbsp;
                          </div>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="7"
                                      <?php echo ($showall == true or in_array(7, $acolarr)) ? "checked" : ""; ?>>
                                  Process</label> &nbsp;
                          </div>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="8"
                                      <?php echo ($showall == true or in_array(8, $acolarr)) ? "checked" : ""; ?>>
                                  Disposition</label> &nbsp;
                          </div>
                    ...
                    ?>
                          ...
                          <div class="col-md-4">
                              ...
                              <label class=""><input type="checkbox" class="choose-col" value="9"
                                      <?php echo ($showall == true or in_array(9, $acolarr)) ? "checked" : ""; ?>>
                                  <?php echo "<th>Referred By</th>"; ?></label> &nbsp;
                          </div><?php
                    }
                    ?>
                          ...
                          <div class="col-md-4">
                              ...
                              <label class=""><input type="checkbox" class="choose-col" value="10"
                                      <?php echo ($showall == true or in_array(10, $acolarr)) ? "checked" : ""; ?>>
                                  <?php echo display("create_date"); ?></label> &nbsp;
                          </div>
                          <div class="col-md-4">

                              <label class=""><input type="checkbox" class="choose-col" value="11"
                                      <?php echo ($showall == true or in_array(11, $acolarr)) ? "checked" : ""; ?>>
                                  <?php echo display("created_by"); ?></label> &nbsp;
                          </div>
                          <div class="col-md-4">

                              <label class=""><input type="checkbox" class="choose-col" value="12"
                                      <?php echo ($showall == true or in_array(12, $acolarr)) ? "checked" : ""; ?>>
                                  <?php echo display("assign_to"); ?></label> &nbsp;
                          </div>

                          <div class="col-md-4">

                              <label class=""><input type="checkbox" class="choose-col" value="13"
                                      <?php echo ($showall == true or in_array(13, $acolarr)) ? "checked" : ""; ?>>
                                  <?php echo display("data_source"); ?></label> &nbsp;
                          </div>
                          <div class="col-md-4">

                              <label class=""><input type="checkbox" class="choose-col" value="14"
                                      <?php echo ($showall == true or in_array(14, $acolarr)) ? "checked" : ""; ?>>
                                  Product</label> &nbsp;
                          </div>

                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="18"
                                      <?php echo ($showall == true or in_array(18, $acolarr)) ? "checked" : ""; ?>>
                                  Score</label> &nbsp;
                          </div>

                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="19"
                                      <?php echo ($showall == true or in_array(19, $acolarr)) ? "checked" : ""; ?>>
                                  Remark</label> &nbsp;
                          </div>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="choose-col" value="17"
                                      <?php echo ($showall == true or in_array(17, $acolarr)) ? "checked" : ""; ?>>EnquiryId</label>
                              &nbsp;
                          </div>
                          ...
                          <div class="col-md-4">
                              ...
                              <label class=""><input type="checkbox" class="choose-col" value="15"
                                      <?php echo ($showall == true or in_array(15, $acolarr)) ? "checked" : ""; ?>>
                                  Bank</label> &nbsp;
                          </div>
                          <?php }?>
                          ...
                          <div class="col-md-4">
                              ...
                              <label class=""><input type="checkbox" class="choose-col" value="16"
                                      <?php echo ($showall == true or in_array(16, $acolarr)) ? "checked" : ""; ?>> Sub
                                  Source</label> &nbsp;
                          </div>
            ...
            if(!empty($dfields)) {           
              ...
              ?>
                          <div class="col-md-4">
                              <label class=""><input type="checkbox" class="dchoose-col choose-col"
                                      value="<?php echo $fld->input_id; ?>"
                                      <?php echo (in_array($fld->input_id, $dacolarr)) ? "checked" : ""; ?>>
                                  <?php echo ucwords($fld->input_label); ?></label> &nbsp;
                          </div>
                          <?php   
      ...
      <div id="deleteselected" class="modal fade" role="dialog">
          <div class="modal-dialog">
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <i class="fa fa-question-circle" style="font-size:100px;"></i><br>
                      <h1>Are you sure, you want to permanently delete selected record?</h1>
                  </div>
                  <div class="modal-footer">
    ...
    function update_top_filter_counter() {
        $.ajax({
            ...
            success: function(responseData) {
                ...
                all_lead_stage_c = $("input[name='top_filter']:checked").next().next().next()
            .html();
