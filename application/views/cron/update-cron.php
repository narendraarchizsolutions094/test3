    ...
    <form action="<?= base_url('cron/insertCron/') ?>" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <input id="minute" type="text" class="form-control" size="4" name="minute" value="<?= $value->minute ?>">
                            </div>
                            <div class="col-xs-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <input id="hour" type="text" class="form-control" size="4" name="hour" value="<?= $value->hour ?>">
                            </div>
                            <div class="col-xs-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <input type="text" class="form-control" size="4" id="day" name="day" value="<?= $value->day ?>">
                            </div>
                            <div class="col-xs-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <input type="text" class="form-control" size="4" id="month" name="month" value="<?= $value->month ?>">
                            </div>
                            <div class="col-xs-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <input type="text" class="form-control" size="4" id="weekday" name="weekday" <?= $value->weekday ?>>
                            </div>
                            <div class="col-xs-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-12 col-lg-6">
                                <input type="text" class="form-control" size="45" name="command" id="command" value="<?= $value->command ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" class="form-control" size="45" name="url" value="<?= $value->url ?>">
                            </div>
