...
<div class="row">
    ...
    <div class="col-md-12" style="background-color: #fff;padding:7px;border-bottom: 1px solid #C8CED3;">
        ...
        <div class="col-md-6" > Installation / Handover document
    ...
    <div class="col-md-9">
        ...
        <div class="panel-body">
           ...
           <br>
                ...
                <form action="<?php echo base_url('Installationprocess/handoverdata') ?>" class="form-inner " id="MyForm" method="post" accept-charset="utf-8">
                    	...
                    	<div class="form-group col-md-3">
                    	  ...
                    	  <input class="form-control" name="report_no" type="text" value="<?= $clientDetails->report_no ?>" readonly>
                    	...
                    	<div class="form-group col-md-3">
                    	  ...
                    	  <input class="form-control form-date" id="r_date"  type="text" value="<?= $clientDetails->added_on ?>" readonly>
                    	...
                    	<div class="form-group col-md-3">
                    	    ...
                    	    <select class="form-control" name="partner_name" readonly>

                    	        <option value="" style="display:none">Select...</option>

                    	        <option value="partner" <?php if($clientDetails->partner=='partner'){echo'selected';}?>>Partner</option>
                    	...
                    	<div class="row">
                        	...
                        	<div class="form-group col-md-3">
                        	    ...
                        	    <input type="text" class="form-control" name="sale_exc" value="<?=$clientDetails->sale_executive ?>" readonly>
                        	...
                        	<div class="form-group col-md-3">
                        	    ...
                        	    <input type="text" class="form-control" name="pre_sale_exc" value="<?=$clientDetails->pre_sale_exec?>" readonly>
                        	...
                        	<div class="form-group col-md-3">
                        	    ...
                        	    <input type="text" class="form-control" name="installation_eng" value="<?=$clientDetails->installation_engg ?>" readonly>
                        	...
                        	<div class="form-group col-md-3">
                        	    ...
                        	    <select class="form-control" name="resident_type" readonly>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <input type="hidden" value="<?=$clientDetails->a_id ?>" name="site_audit" class="form-control">

                                <?php foreach($floor as $rows){ ?>
                                ...
                                <tr> 
                                    ...
                                    <td><?= $rows->baq_floor ?><input type="hidden" value="<?= $rows->baq_floor ?>" name="floor"></td>

                                    <td><?= $rows->baq_room ?><input type="hidden" value="<?= $rows->baq_room ?>" name="area"></td>
                                      ...
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <div class="row">
                                               ...
                                               <div class="form-group col-md-6">
                                                    ...
                                                    <input  class="form-control form-date" name="date1">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input  class="form-control form-date" name="date2">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <?php if($exits->client_id!=$clientDetails->cli_id){ ?>
