...
<div class="row">
    ...
    <div class="sgnbtnmn form-group col-md-12">
                    ...
                    <tbody>
                            ...
                            <?php foreach ($lead_stages as $stage) {  ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?> clickable-row" style="cursor:pointer;"  >
                                    ...
                                    <td><?php echo !empty($stage->product_name)?$stage->product_name:'NA';?></td>
      ...
      <select  class="form-control" name="process">
        <option>Select</option>
         <?php foreach($products as $product){?>
         <option value="<?=$product->sb_id ?>" <?php if($product->sb_id==$stage->process_id){?>selected <?php }?>><?=$product->product_name ?></option>
        <?php } ?>
      </select>
