                                        ...
                                        <div class="row justify-content-center">
											...
											<div class="row m-t-20">
                                                   <?php if(!empty($this->session->error)){?>
                                                    <div class='btn  btn-danger text-left' ><?php echo $this->session->error; ?></div>
                                                <?php     }?>
                                                <?php if(!empty($this->session->success)){?>
                                                    <div class='btn  btn-success text-left' ><?php echo $this->session->success; ?></div>
                                                <?php     }?>
                                                </div>
												<?php foreach($edit_main as $vla){ ?>
											<div class="row m-t-20">
                                                    <div class="col-12">
                                                        <label for="name" class="col-form-label"> Main function </label>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group ">
                                                            <div class="input_icon">
                                                                  <input type="text" id="comp_name"  class="form-control br_25  m-0 icon_left_input" placeholder="Add Main function" name="area_name" value="<?php echo $vla->a_name;?>">
