            ...
            $(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#circuit_sheet").html(obj['circuit_sheet']
                        .circuit_sheet); // total circuit_sheet            
                        $("#boq").html(obj['circuit_sheet'].boq); // total boq.                    
                        $("#po").html(obj['po'].po);
                        $(".total-qnq").html(obj['enquiry'][0].total); //Total enquiry..
                        $(".enq-total").html(obj['enquiry'][0].total_value).css('font-weight',
                            'bold');
                        //Enquiry total value...
                        $(".enq-active").html(obj['enquiry'][0]
