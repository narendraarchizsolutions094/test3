      ...
      <div class="col-md-6" >
         <div style="float:right">
          <?php  if($enquiry->status==2) { if($this->session->userdata('companey_id')==29){ ?>
            ...
            <div class="btn-group" role="group" aria-label="Button group">
               <a class="dropdown-toggle" href="#" data-toggle="modal" data-target="#addnewdeal" title="Add New Deal"> <i class="fa fa-plus" style="background:#fff !important;border:none!important;color:green;"></i>NEW DEAL</a>&nbsp;&nbsp;&nbsp;
            </div>
