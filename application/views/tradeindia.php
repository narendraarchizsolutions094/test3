	...
	<table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="th2"><?php echo display('tradeindia_key');?></th>
                            <th class="th2"><?php echo display('userid');?></th>
                            <th class="th2"><?php echo display('user_profileid');?></th>
                        ...
                        <?php if (!empty($web_intergrationlist)) { ?>
                            ...
                            <?php foreach ($web_intergrationlist as $list) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="cursor:pointer;">
                                    ...
                                    <td class="th2"><?php echo $list->p_key; ?></td> 
                                    <td class="th2"><?php echo $list->p_userid; ?></td> 
                                    <td class="th2"><?php echo $list->p_profileid; ?></td> 
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Use our Tradeindia integration link to capture enquiries, to create your link provide information below</h4>
      </div>
            ...
            <?php echo form_open_multipart('configurations/createportalintegration','class="form-inner"') ?>                      
              ...
              <div class="row">
                ...
                <div class="form-group   col-sm-6">
                    <input type="hidden" name="portal_type" value="2">
                ...
                <div class="form-group  col-sm-6">
                    <label><?php echo display('userid');?>*</label>
                    <input type="text" name="userid" class="form-control" value="" >
                </div>
                
                <div class="form-group  col-sm-6">
                    <label><?php echo display('user_profileid');?>*</label>
                    <input type="text" name="user_profileid" class="form-control" value="" >
                </div>
                
                <div class="form-group  col-sm-6">
                    <label><?php echo display('tradeindia_key');?>*</label>
