    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success"  href="<?php echo base_url();?>add-sub-function" > <i class="fa fa-plus"></i>  <?php echo display('Add_More') ?> </a> 
                ...
                <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                       <tr role="row">
                                                ...
                                                <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Function Name </th>
                                                <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Sub Function Name </th>
                    ...
                    <tbody>
                     	<?php $i=1;foreach($all_item as $user){?>
                                            <tr role="row" class="even">
											  <td><input type='checkbox' name='user_status[]' class="checkbox" value='<?php echo $user->s_itemlist_id;?>'>&nbsp;</td>
                                                  	<td class="wid-10" style="border-left:none;"><?php echo $i;?> </td>
                                                <td class="sorting_1 user_face">
                                                
												<?php echo $user->item_name;?></td>
                                               	
                                                <td class="center"> <?php echo $user->sub_f_name;?></td>

												<td class="center"> <?php if($user->item_status==1)
											 ...
											 <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" 
                                                        href="<?php echo base_url();?>edit-sub-functions/<?php echo base64_encode($user->s_itemlist_id);?>"><i class="ti-pencil"></i></a>
...
$.ajax({
type: 'POST',
url: '<?php echo base_url();?>dash/active_sub_function',
...
if(data=='User Exist'){	
	...
	$('#success').html(data);
	window.location.href = '<?php echo base_url()?>sub-function-list';
}
})
.fail(function() {
alert( "fail!" );
...
$.ajax({
type: 'POST',
url: '<?php echo base_url();?>dash/deactive_sub_function',
data: $('#login').serialize()
})
.done(function(data){
if(data=='User Exist'){	
