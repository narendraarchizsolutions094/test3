...
<div class="container-fluid">
 <section class="category-course-list-area">
        <div class="category-filter-box filter-box clearfix">
            ...
            <span>Showing Total : <?php echo count($courses); ?></span>
        ...
        <div class="col-md-12">
				...
				<?php if(!empty($courses)) { ?>
					...
					<?php if(!empty($_SESSION["layout"]) and $_SESSION["layout"] == "list") { 
...
function toggleLayout(layout) {
    $.ajax({
        type : 'POST',
        url : '<?php echo site_url('dashboard/set_layout_to_session'); ?>',
        data : {layout : layout},
