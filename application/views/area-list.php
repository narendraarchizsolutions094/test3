    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url();?>add-main-function"> <i class="fa fa-plus"></i>  <?php echo display('Add_More') ?> </a> 
                ...
                <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                         <tr role="row">
                                                ...
                                                <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Main function Name</th>
                    ...
                    <tbody>
                      	<?php $i=1;foreach($get_users as $user){?>
                                            <tr role="row" class="even">
											  <td><input type='checkbox' name='user_status[]' class="checkbox" value='<?php echo $user->a_id;?>'>&nbsp; <?php echo $i;?></td>
                                                <td class="sorting_1 user_face">
												 <?php echo $user->a_name;?></td>
                                                
												<td class="center">
												     <?php if($user->area_status==1)
                                               ...
                                               <td>&nbsp; &nbsp;
												 <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" 
                                                        href="<?php echo base_url();?>edit-mainfun/<?php echo base64_encode($user->a_id);?>"><i class="ti-pencil"></i></a>
...
$.ajax({
type: 'POST',
url: '<?php echo base_url();?>dash/active_area',
...
if(data=='User Exist'){	
	...
	$('#success').html(data);
		window.location.href = '<?php echo base_url()?>area-list';
}
})
.fail(function() {
alert( "fail!" );
...
$.ajax({
type: 'POST',
url: '<?php echo base_url();?>dash/dactive_area',
data: $('#login').serialize()
})
.done(function(data){
if(data=='User Exist'){	
	...
	document.getElementById('success').style.display='inline';
	$('#success').html(data);
		window.location.href = '<?php echo base_url()?>main-function';
}
})
.fail(function() {
alert( "fail!" );
