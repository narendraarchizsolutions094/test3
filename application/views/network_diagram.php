...
<div class="row">
    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary"> <i class="fa fa-list"></i> Layout Sheet </a>  
                </div>
            </div> 
    ...
    <!-- Modal content-->
      <form action="<?php echo base_url();?>lead/network_digram" method="post" enctype="multipart/form-data">
    <div class=" card">

      <div>
                <div class="form-group col-sm-12"> 
                <label>Upload Layout Sheet</label>
       ...
       <div class="col-md-12">
                  ...
                  <!-- <a herf="<?php echo base_url();?>/lead" class="btn btn-info" >Back To Lead</a>-->
              </div>
