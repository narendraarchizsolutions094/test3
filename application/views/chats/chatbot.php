                ...
                <div class="chat-logs">
                    <div class="card">
                        ...
                        <div class="card-body" style="padding: 8px;">
                            <form action="<?=base_url().'chat/submit_identity/'.$comp_id.'/'.$created_by?>"
                                id='chat_identity_form' method='post'>
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 col-form-label col-form-label-sm">Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" placeholder="Full Name"
                                            value="<?=!empty($this->session->chat_fullname)?$this->session->chat_fullname:''?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control " id="mobile" placeholder="Mobile No."
                                            value="<?=!empty($this->session->chat_mobile)?$this->session->chat_mobile:''?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control " id="email" placeholder="Email Id"
                                            value="<?=!empty($this->session->chat_email)?$this->session->chat_email:''?>">
                                    </div>
                                </div>
    ...
    const msg_observer = msg.onSnapshot(docSnapshot => {
        docSnapshot.docChanges().forEach(change => {
            ...
            if (change.type === 'added') {
                ...
                if (isNaN(msg1_data.sender_id) && msg1_data.sender_id ==
                    "<?=$this->session->chat_user_id?>") {
                    uid = msg1_data.sender_id;
                    generate_message(msg1_data.message, 'self', msg1_data.time);
                } else if (!isNaN(msg1_data.sender_id) && msg1_data.receiver_id ==
                    "<?=$this->session->chat_user_id?>") {
