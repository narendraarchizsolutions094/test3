                                ...
                                <div class="col-lg-10 ">
                                    ...
                                    <form   action='' method="post" id="login">
                                        <div class="row justify-content-center">
											...
											<?php foreach($floor_byid as $vla){ ?>
											<div class="row m-t-20">
                                                    <div class="col-12">
                                                        <label for="name" class="col-form-label">Floor Name </label>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group ">
                                                            <div class="input_icon">
                                                                  <input type="text" id="comp_name"  class="form-control br_25  m-0 icon_left_input" placeholder="Floor Name" name="area_name" value="<?php echo $vla->f_name;?>">
