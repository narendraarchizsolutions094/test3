<div class="row">
    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <?php if (user_access(14)==true) { ?>

            <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("location/add_region") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_region') ?> </a>  
                </div>
            <?php } ?>
            </div>
