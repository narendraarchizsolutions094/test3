                   ...
                   // $n=1;
                    ...
                    ?>
                     ...
                     <tr class="<?=$value['id']?>">                        
                        ...
                        <?php for($j=0; $j <=6; $j++){ ?>
                        <td class="text-center"><input type="checkbox" width="10px;" name="permissions[]"  value="<?php echo $value['id'].$j;  ?>" class="all_check check_all<?php echo $value['id'];  ?> check_alls<?php echo $j;  ?> form-check-input" ></td>
                        <?php }?>                      
                      </tr>
                      <?php 
