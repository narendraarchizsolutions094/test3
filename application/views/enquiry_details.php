...
<div class="row">
   ...
   <div  class="row" id="ThreadEnq">
      <div class="col-md-3 col-height" style="text-align:center;background:#fff;">
         ...
         <h5 style="text-align:center"><br><br><?= $enquiry->name_prefix." ".$enquiry->name." ".$enquiry->lastname ?>
            <br><?php if($enquiry->gender == 1) { echo 'Male'; }else if($enquiry->gender == 2){ echo 'Female'; }else if($enquiry->gender == 3){ echo 'Other';} ?>
            <br>
         ...
         <div class="row">
            ...
            <a class="btn btn-danger btn-outline-dark btn-md"  href="<?php echo base_url();?>enquiry/active_enquery/<?php echo $enquiry->enquiry_id ?>" title="Active Enquiry"  data-toggle="modal">
