            ...
            <div class="panel-body panel-form">
                ...
                <div class="row">
                      <div class="form-group row">
                        <label for="specialist" class="col-xs-9 col-form-label "><h1><?php echo display('personal_info') ?></h1></label>
                      </div>
                        ...
                        <?php echo form_open_multipart('customer/create','class="form-inner"') ?>
                            <?php echo form_hidden('user_id',$doctor->user_id) ?>
								...
								<ul class="nav nav-tabs">
									...
									<li><a data-toggle="tab" href="#acnt-details"  id="act-det-info"><?php echo display('account_details') ?> </a></li>
									<li><a data-toggle="tab" href="#comp-details" id="add-cmp-det"><?php echo display('add_companey_details') ?></a></li>
								</ul>
                            ...
                            <!-- if representative picture is already uploaded -->
										...
										<div class="form-group row">
											...
											<div class="col-xs-9">
												<input type="file" name="picture" id="picture" value="<?php echo $doctor->pictures ?>">
					...
					<div id="acnt-details" class="tab-pane fade">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="a_validupto" value="<?=date('Y-m-d', strtotime(date('Y-m-d'). ' + 7 days'));?>" class="form-control"  placeholder="Valid Upto"  id="validupto"/>
                               </div>
                            </div>
