        ...
        <div class="container">
            <div class="header-wrapper">
                ...
                <ul class="menu">
                    ...
                    <li>
                        <a href="<?= base_url('website/home/student')?>" class="active">Home</a>
                       
                    </li>
                     <li>
                        <a href="<?= base_url('website/home/student')?>#services">Services</a>
                       
                    </li>
    
          
                    <li>
                        <a href="<?= base_url('website/home/student')?>#aboutus">About US</a>
                       
                    </li>
                     <li>
                        <a href="<?= base_url('website/home/student')?>#sponsers">Sponsers</a>
                    </li>
                     <li>
                        <a href="<?= base_url('website/home/student')?>#testimonials">Testimonials</a>
                    </li>
           
                    <li>
                        <a href="<?= base_url('website/home/student')?>#contact">contact</a>
                    </li>
                   
                    <li class="header-button pr-0">
                        <a href="<?= base_url('website/home/login')?>">Login</a>
                    </li>
        ...
        <div class="container">
            <div class="padding-top padding-bottom">
                <div class="account-area">
                    ...
                    <form class="account-form" action="<?= base_url('website/home/signupuser')?>" method="post">
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Your Mobile" id="phone" name="phone" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="option">
                        Already have an account? <a href="<?= base_url('website/home/login')?>">Login</a>
                    </div>
