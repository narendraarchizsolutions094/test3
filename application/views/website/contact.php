...
<body>
    ...
    <header class="header-section">
        <div class="container">
            <div class="header-wrapper">
                ...
                <ul class="menu">
                    <li>
                        <a href="<?= base_url('website/home/signup_user')?>" class="active">Join as User</a>
                       
                    </li>
                    <li>
                        <a href="<?= base_url('website/home/signup_university')?>">Join as University</a>
          
                    </li>
                    
                   
                    <li>
                        <a href="<?= base_url('website/home/contact')?>">contact</a>
                    </li>
    ...
    <!-- ==========Banner-Section========== -->
    <section class="main-page-header speaker-banner bg_img" data-background="<?= base_url('assets_web1/images/')?>banner07.jpg">
        <div class="container">
            ...
            <div class="container">
                <div class="newslater-container bg_img" data-background="<?= base_url('assets_web1/images/')?>newslater-bg01.jpg">
                    <div class="newslater-wrapper">
                        <h5 class="cate">subscribe to University</h5>
        ...
        <div class="container">
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-area">
                    <div class="left">
                        <p>Copyright © 2020.All Rights Reserved By <a href="#0">Archiz Solutions </a></p>
                    </div>
                    <ul class="links">
                        <li>
                            <a href="#0">About</a>
