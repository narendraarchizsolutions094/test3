	...
	<table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="th2"><?php echo display('indiamart_key');?></th>
                            <th class="th2"><?php echo display('primary_num');?></th>
                        ...
                        <?php if (!empty($web_intergrationlist)) { ?>
                            ...
                            <?php foreach ($web_intergrationlist as $list) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="cursor:pointer;">
                                    ...
                                    <td class="th2"><?php echo $list->p_primaryno; ?></td> 
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Use our Indiamart integration link to capture enquiries, to create your link provide information below</h4>
      </div>
            ...
            <?php echo form_open_multipart('configurations/createportalintegration','class="form-inner"') ?>                      
              ...
              <div class="row">
                ...
                <div class="form-group   col-sm-6">
                    <input type="hidden" name="portal_type" value="1">
                ...
                <div class="form-group  col-sm-6">
                    <label><?php echo display('indiamart_key');?>*</label>
                    <input type="text" name="key" class="form-control" value="" >
                </div>
                
                <div class="form-group  col-sm-6">
                    <label><?php echo display('primary_num');?>*</label>
                    <input type="text" name="primary_number" class="form-control" value="" >
                </div>
