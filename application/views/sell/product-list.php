		...
		$.ajax({
			...
			success	: function(resp){
				...
				if(jresp.status == 1){					
					...
					var tprice = parseInt(jresp.price) * parseInt(jresp.qty);
					var htmcnt = '<li id = "cart-li-'+jresp.prodid+'"><div class="cart-items"><h4><a href="">'+jresp.product+' </a></h4>'+
									'<p><a href=""> Price : <i class="fa fa-rupee"></i> '+jresp.price+' X '+'<input type="number" value="'+jresp.qty+'" min=1 class="cart-qty" data-prodid='+jresp.prodid+'>'+' = <i class="fa fa-rupee"></i> <p class="item-price">'+tprice+'</p> </a>'+ 
