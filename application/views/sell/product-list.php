					...
					?>
						<div class = "col-md-3 ">
							...
							<p> <i class = "fa fa-rupee"></i> <strike><?php
								...
								?></strike> <b><i class = "fa fa-rupee"></i><?php echo $prd->price ?></b></p>
									<div>
									<?php if($prd->stock  == 0){
										?>Out Of Stock<?php
									}else{
								...
								<div class = "box-content text-left" style = "text-align:left;">
									...
									<a href = "javascript:void(0)" class = "minus-quantity" data-prodid = "<?php echo $prd->id; ?>"><span> - </span></a>
									<?php } ?>
									
									<a href = "javascript:void(0)" data-prodid = "<?php echo $prd->id; ?>" class = "add-to-cart">
