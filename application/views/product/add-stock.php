    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail"> 
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("product/addstock") ?>"> <i class="fa fa-list"></i> Add Stock </a>  
                </div>
            </div>
				...
				<!--	<div class="form-group col-md-6 prod-details">
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group">
								...
								</div><input class="form-control fc-datepicker datepicker" name="stockdate"  placeholder="MM/DD/YYYY" value = "<?php echo set_value("stockdate"); ?>" type="date" style = "width:100%;">
							</div>
						</div>
						<div class="form-group col-md-6">
							<label>Supplier : <b class = "mand"></b></label>
							<input type="text" class="form-control" name="supplier" placeholder="Supplier " value="<?php echo set_value("supplier"); ?>" required> 
						</div>
						</div>
						<div class="form-group col-md-6">
							<label>Quantity :</label>
							<input type="number" class="form-control" name="quantity" placeholder="Enter Quantity" value="<?php echo set_value("quantity"); ?>" required>
						</div>
						<div class="form-group col-md-6">
							<label>Price :</label>
