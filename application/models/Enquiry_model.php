...
/*----------------------- all Dropped Enquiry----------------------*/
    ...
    public function enquiry_by_id($enquiry_id) {
        return $this->db->select("*,enquiry.city_id as enquiry_city_id,enquiry.state_id as enquiry_state_id,enquiry.created_date,enquiry.status,enquiry.address,tbl_product_country.country_name,tbl_product_country.id as country_id,tbl_product.product_name,tbl_center.center_name,enquiry.lead_created_date")
                        ->from($this->table)
                        ->join('tbl_product_country', 'tbl_product_country.id=enquiry.country_id', 'left')
