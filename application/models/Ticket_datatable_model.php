...
class Ticket_datatable_model extends CI_Model{
    ...
    public function _get_datatables_query($postData){
        ...
        {
            $sel_string[] = " concat(for_assign.s_display_name,' ',for_assign.last_name,' ',tck_conv.msg) as assign_to_name  ";
        }
        ...
        $this->db->join("(select * from (select * from tbl_ticket_conv order by tbl_ticket_conv.id DESC) as tck_conv1 group by tck_conv1.tck_id) as tck_conv","tck_conv.tck_id=tck.id","LEFT");
